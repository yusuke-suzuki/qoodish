...
ActiveRecord::Schema.define(version: 20_220_731_083_040) do
  ...
  create_table 'devices', charset: 'utf8mb4', force: :cascade do |t|
    ...
    t.index %w[user_id registration_token], name: 'index_devices_on_user_id_and_registration_token', unique: true
  ...
  create_table 'invites', charset: 'utf8mb4', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[invitable_id invitable_type], name: 'index_invites_on_invitable_id_and_invitable_type'
    t.index %w[invitable_type invitable_id], name: 'index_invites_on_invitable_type_and_invitable_id'
    t.index %w[recipient_id recipient_type], name: 'index_invites_on_recipient_id_and_recipient_type'
    t.index %w[recipient_type recipient_id], name: 'index_invites_on_recipient_type_and_recipient_id'
    t.index %w[sender_id sender_type], name: 'index_invites_on_sender_id_and_sender_type'
    t.index %w[sender_type sender_id], name: 'index_invites_on_sender_type_and_sender_id'
  end
  ...
  create_table 'notifications', charset: 'utf8mb4', force: :cascade do |t|
    ...
    t.index %w[notifiable_type notifiable_id], name: 'index_notifications_on_notifiable_type_and_notifiable_id'
    t.index %w[notifier_id notifier_type], name: 'index_notifications_on_notifier_id_and_notifier_type'
    t.index %w[notifier_type notifier_id], name: 'index_notifications_on_notifier_type_and_notifier_id'
    t.index %w[recipient_id recipient_type], name: 'index_notifications_on_recipient_id_and_recipient_type'
  ...
  create_table 'place_details', charset: 'utf8mb4', force: :cascade do |t|
    ...
    t.index %w[place_id_val locale], name: 'index_place_details_on_place_id_val_and_locale', unique: true
  end
  ...
  create_table 'reviews', charset: 'utf8mb4', force: :cascade do |t|
    ...
    t.index %w[spot_id map_id user_id], name: 'index_reviews_on_spot_id_and_map_id_and_user_id', unique: true
  ...
  create_table 'spots', charset: 'utf8mb4', force: :cascade do |t|
    ...
    t.index %w[place_id map_id], name: 'index_spots_on_place_id_and_map_id', unique: true
  end
